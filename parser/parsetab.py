...
_lr_productions = [
  ...
  ('program -> lista_sentencias','program',1,'p_program','parser.py',23),
  ('lista_sentencias -> lista_sentencias sentencia','lista_sentencias',2,'p_lista_sentencias_multiple','parser.py',28),
  ('lista_sentencias -> sentencia','lista_sentencias',1,'p_lista_sentencias_simple','parser.py',32),
  ('sentencia -> INT ID PUNTO_COMA','sentencia',3,'p_sentencia_declaracion','parser.py',37),
  ('sentencia -> FLOAT ID PUNTO_COMA','sentencia',3,'p_sentencia_declaracion','parser.py',38),
  ('sentencia -> BOOL ID PUNTO_COMA','sentencia',3,'p_sentencia_declaracion','parser.py',39),
  ('sentencia -> STRING ID PUNTO_COMA','sentencia',3,'p_sentencia_declaracion','parser.py',40),
  ('sentencia -> INT ID ASIGNACION expr PUNTO_COMA','sentencia',5,'p_sentencia_declaracion','parser.py',41),
  ('sentencia -> FLOAT ID ASIGNACION expr PUNTO_COMA','sentencia',5,'p_sentencia_declaracion','parser.py',42),
  ('sentencia -> BOOL ID ASIGNACION expr PUNTO_COMA','sentencia',5,'p_sentencia_declaracion','parser.py',43),
  ('sentencia -> STRING ID ASIGNACION expr PUNTO_COMA','sentencia',5,'p_sentencia_declaracion','parser.py',44),
  ('sentencia -> ID ASIGNACION expr PUNTO_COMA','sentencia',4,'p_sentencia_asignacion','parser.py',52),
  ('sentencia -> IF IZQ_PAREN expr DER_PAREN sentencia','sentencia',5,'p_sentencia_if','parser.py',57),
  ('sentencia -> IF IZQ_PAREN expr DER_PAREN sentencia ELSE sentencia','sentencia',7,'p_sentencia_if','parser.py',58),
  ('sentencia -> WHILE IZQ_PAREN expr DER_PAREN sentencia','sentencia',5,'p_sentencia_while','parser.py',66),
  ('sentencia -> IZQ_BRACE lista_sentencias DER_BRACE','sentencia',3,'p_sentencia_bloque','parser.py',71),
  ('expr -> expr SUMA expr','expr',3,'p_expr_binaria','parser.py',76),
  ('expr -> expr RESTA expr','expr',3,'p_expr_binaria','parser.py',77),
  ('expr -> expr MULT expr','expr',3,'p_expr_binaria','parser.py',78),
  ('expr -> expr DIV expr','expr',3,'p_expr_binaria','parser.py',79),
  ('expr -> expr MOD expr','expr',3,'p_expr_binaria','parser.py',80),
  ('expr -> expr EQ expr','expr',3,'p_expr_binaria','parser.py',81),
  ('expr -> expr NEQ expr','expr',3,'p_expr_binaria','parser.py',82),
  ('expr -> expr LT expr','expr',3,'p_expr_binaria','parser.py',83),
  ('expr -> expr GT expr','expr',3,'p_expr_binaria','parser.py',84),
  ('expr -> expr LE expr','expr',3,'p_expr_binaria','parser.py',85),
  ('expr -> expr GE expr','expr',3,'p_expr_binaria','parser.py',86),
  ('expr -> expr AND expr','expr',3,'p_expr_binaria','parser.py',87),
  ('expr -> expr OR expr','expr',3,'p_expr_binaria','parser.py',88),
  ('expr -> NOT expr','expr',2,'p_expr_unaria','parser.py',93),
  ('expr -> IZQ_PAREN expr DER_PAREN','expr',3,'p_expr_group','parser.py',98),
  ('expr -> INT_CONST','expr',1,'p_expr_atom','parser.py',103),
  ('expr -> FLOAT_CONST','expr',1,'p_expr_atom','parser.py',104),
  ('expr -> BOOL_CONST','expr',1,'p_expr_atom','parser.py',105),
  ('expr -> STRING_CONST','expr',1,'p_expr_atom','parser.py',106),
  ('expr -> ID','expr',1,'p_expr_atom','parser.py',107),
]
